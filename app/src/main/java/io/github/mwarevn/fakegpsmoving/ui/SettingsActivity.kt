...
import io.github.mwarevn.fakegpsmoving.databinding.ActivitySettingsBinding
    ...
    class SettingsPreferenceFragment : PreferenceFragmentCompat() {
        ...
        private fun isJoystickRunning(): Boolean {
            ...
            for (service in manager.getRunningServices(Int.MAX_VALUE)) {
                if ("io.github.mwarevn.fakegpsmoving.utils.JoystickService" == service.service.className) {
                    isRunning = true
                }
            }
            return isRunning
